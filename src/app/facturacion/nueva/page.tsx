...
function NuevaFacturaForm() {
  ...
  return (
    <div className="p-8 max-w-4xl">
      <h1 className="text-2xl font-bold text-[#1a3d2b] mb-6">Nueva factura</h1>

      <form onSubmit={handleSubmit} className="flex flex-col gap-5">
        <div className="bg-white rounded-2xl border border-[#e5e7eb] p-5 shadow-sm">
          <h2 className="font-semibold text-[#1a3d2b] mb-4">Tipo de comprobante</h2>
            ...
            {TIPOS_FACTURA.map((t) => (
              <button
                ...
                className={`border-2 rounded-xl p-3 text-center transition-colors ${
                  tipoFactura === t.value
                    ? "border-[#f47c3a] bg-[#fff5ef]"
                    : "border-[#e5e7eb] hover:border-[#52b788]"
                }`}
              >
                <div className="text-xl font-bold text-[#1a3d2b]">{t.value}</div>
                <div className="text-[10px] text-[#6b7280] mt-0.5 leading-tight">{t.desc}</div>
              </button>
            ))}
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-[#e5e7eb] p-5 shadow-sm">
          <h2 className="font-semibold text-[#1a3d2b] mb-4">Datos del comprobante</h2>
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium text-[#1a3d2b] mb-1">Punto de venta</label>
              <input
                type="number"
                min="1"
                value={puntoVenta}
            ...
            <div>
              <label className="block text-sm font-medium text-[#1a3d2b] mb-1">Condición de venta</label>
              <select
        ...
        <div className="bg-white rounded-2xl border border-[#e5e7eb] p-5 shadow-sm">
          <div className="flex justify-between items-center mb-4">
            <h2 className="font-semibold text-[#1a3d2b]">Ítems</h2>
            <button type="button" onClick={addItem} className="text-sm text-[#f47c3a] font-medium hover:underline">
              + Agregar ítem
            </button>
          </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead>
                <tr className="text-left text-[#6b7280] text-xs border-b border-[#f3f4f6]">
                    ...
                    <tr key={i} className="border-b border-[#f9fafb]">
                      <td className="py-2 pr-2">
                        <input
                          ...
                          className="w-full border border-[#e5e7eb] rounded px-2 py-1.5 text-xs focus:outline-none focus:ring-1 focus:ring-[#52b788]"
                        />
                      </td>
                      <td className="py-2 pr-2">
                        <input
                          ...
                          className="w-16 border border-[#e5e7eb] rounded px-2 py-1.5 text-xs focus:outline-none focus:ring-1 focus:ring-[#52b788]"
                        />
                      </td>
                      <td className="py-2 pr-2">
                        <select
                          ...
                          className="border border-[#e5e7eb] rounded px-2 py-1.5 text-xs focus:outline-none focus:ring-1 focus:ring-[#52b788]"
                        >
                      ...
                      <td className="py-2 pr-2">
                        <input
                          ...
                          className="w-24 border border-[#e5e7eb] rounded px-2 py-1.5 text-xs focus:outline-none focus:ring-1 focus:ring-[#52b788]"
                        />
                      </td>
                      <td className="py-2 pr-2">
                        <input
                          ...
                          className="w-14 border border-[#e5e7eb] rounded px-2 py-1.5 text-xs focus:outline-none focus:ring-1 focus:ring-[#52b788]"
                        />
                      </td>
                      <td className="py-2 pr-2">
                        <select
          ...
          <div className="mt-4 pt-4 border-t border-[#f3f4f6] flex justify-end gap-8 text-sm">
            <div className="text-right flex flex-col gap-1">
              <div className="flex justify-between gap-8 text-[#6b7280]">
              ...
              <div className="flex justify-between gap-8 text-lg font-bold text-[#1a3d2b] pt-1 border-t border-[#e5e7eb]">
                <span>Total:</span>
